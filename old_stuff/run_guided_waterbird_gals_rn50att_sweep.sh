#!/bin/bash -l
# Guided sweep on Waterbirds-95 using GALS RN50 attention maps as guidance.
...
#SBATCH --mem=64G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/guided_galsrn50_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/guided_galsrn50_sweep_%j.err
...
SWEEP_OUT=${SWEEP_OUT:-$LOG_DIR/guided_galsrn50_sweep_${SLURM_JOB_ID}.csv}
POST_SEEDS=${POST_SEEDS:-5}
POST_SEED_START=${POST_SEED_START:-0}
POST_OUT=${POST_OUT:-$LOG_DIR/guided_galsrn50_sweep_best5_${SLURM_JOB_ID}.csv}
