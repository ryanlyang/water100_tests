...
#SBATCH --mem=64G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/guided_sweep_attn0_100_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/guided_sweep_attn0_100_%j.err
...
SWEEP_OUT=${SWEEP_OUT:-$LOG_DIR/guided_waterbird_sweep_attn0_100_${SLURM_JOB_ID}.csv}
SEEDS_OUT=${SEEDS_OUT:-$LOG_DIR/guided_waterbird_sweep_attn0_100_seeds_${SLURM_JOB_ID}.csv}
...
srun --unbuffered python -u run_guided_waterbird_sweep_attn0.py \
  "$DATA_ROOT" \
  "$GT_ROOT" \
  --n-trials "$N_TRIALS" \
