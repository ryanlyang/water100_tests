...
#SBATCH --mem=64G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/guided_95_New_Teach_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/guided_95_New_Teach_%j.err
...
GT_ROOT=/home/ryreu/guided_cnn/waterbirds/New_Teach/LearningToLook/code/WeCLIPPlus/results/val/prediction_cmap
...
SUMMARY_CSV=${SUMMARY_CSV:-$LOG_DIR/guided_95_New_Teach_${SLURM_JOB_ID}.csv}
...
for SEED in $SEEDS; do
  RUN_LOG="$LOG_DIR/guided_95_New_Teach_seed${SEED}_${SLURM_JOB_ID}.log"
  echo "=== SEED ${SEED} ==="
