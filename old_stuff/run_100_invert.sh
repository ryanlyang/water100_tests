...
#SBATCH --mem=64G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/100_invert_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/100_invert_sweep_%j.err
...
srun --unbuffered python -u run_waterbird_invert_sweep.py \
  "$DATA_ROOT" \
  "$GT_ROOT" \
  --n-trials "$N_TRIALS" \
