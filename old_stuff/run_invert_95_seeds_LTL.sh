...
#SBATCH --mem=64G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbirdSeeds/invert_95_LTL_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbirdSeeds/invert_95_LTL_%j.err
...
ATTENTION_EPOCH=58
KL_LAMBDA=1.167120230297485
BASE_LR=0.0015941092070707937
CLASSIFIER_LR=0.000010887145455491895

SEEDS=${SEEDS:-"0 1 2 3 4"}
SUMMARY_CSV=${SUMMARY_CSV:-$LOG_DIR/invert_95_LTL_${SLURM_JOB_ID}.csv}
...
for SEED in $SEEDS; do
  RUN_LOG="$LOG_DIR/invert_95_LTL_seed${SEED}_${SLURM_JOB_ID}.log"
  echo "=== SEED ${SEED} ==="
