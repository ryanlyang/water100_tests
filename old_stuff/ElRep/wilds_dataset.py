...
class WILDSDataset:
    ...
    def eval(self, y_pred, y_true, metadata, grouper='adjusted'):
        """
        Args:
...
class WILDSSubset(WILDSDataset):
    def __init__(self, dataset, indices, transform, do_transform_y=False):
        ...
        self._collate = self.dataset.collate
    ...
    def eval(self, y_pred, y_true, metadata, grouper='adjusted'):
        return self.dataset.eval(y_pred, y_true, metadata, grouper=grouper)
