...
# ---------------------------------------------------------------------------
# Model: same conv backbone as DecoyMNIST Net (1-ch input, 20/50 channels),
# with AdaptiveAvgPool + single Linear instead of fc1+fc2, so CAMs work.
# ---------------------------------------------------------------------------
class Net(nn.Module):
...
# Args
# ---------------------------------------------------------------------------
parser = argparse.ArgumentParser(description='PyTorch DecoyMNIST Guided LeNet Training')
...
# ---------------------------------------------------------------------------
# Data loading — grayscale DecoyMNIST PNGs, normalized to [-1, 1]
# ---------------------------------------------------------------------------
