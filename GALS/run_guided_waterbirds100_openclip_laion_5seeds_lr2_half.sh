#!/bin/bash -l
# WB100 local sensitivity: lr2_mult*0.75 (from 0.123 -> 0.09225), others fixed.
...
export LR2_MULT=0.09225
export SUMMARY_CSV="${SUMMARY_CSV:-/home/ryreu/guided_cnn/logsWaterbird/guided100_sens_lr2075_${SLURM_JOB_ID}.csv}"
