...
SBATCH=experiments/spucodogs_mask_audit/slurm/audit_spucodogs_masks.sbatch
...
job_id=${raw_job_id%%;*}
echo "[DONE] Submitted SpuCoDogs mask audit job: $job_id"
echo "Monitor: squeue -j $job_id"
echo "Logs: $OUTPUT/run_logs/audit_${job_id}.out"
echo "      $OUTPUT/run_logs/audit_${job_id}.err"
