#!/usr/bin/env python3
"""Attach analysis-only test metrics and generate final DecoyMNIST FCV reports."""
...
from decoy_selection_analysis import analyze_posthoc_results  # noqa: E402
...
def main() -> None:
    ...
    summary = analyze_posthoc_results(
