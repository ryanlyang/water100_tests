...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/waterbirds95_gals_sweep_vit_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/waterbirds95_gals_sweep_vit_%j.err
...
OUT_CSV="$LOG_DIR/gals95_sweep_vit_${SLURM_JOB_ID}.csv"
TRIAL_LOGS="$LOG_DIR/gals95_sweep_vit_logs_${SLURM_JOB_ID}"

ARGS=(--config configs/waterbirds_95_gals_vit.yaml
  --data-root "$DATA_ROOT"
