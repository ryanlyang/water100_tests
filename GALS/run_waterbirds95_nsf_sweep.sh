#!/bin/bash -l
# NSF sweep (Optuna) for Waterbirds-95.
...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/waterbirds95_nsf_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/waterbirds95_nsf_sweep_%j.err
...
OUT_CSV=${OUT_CSV:-$LOG_DIR/nsf95_sweep_${SLURM_JOB_ID}.csv}
POST_OUT_CSV=${POST_OUT_CSV:-$LOG_DIR/nsf95_best5_${SLURM_JOB_ID}.csv}
