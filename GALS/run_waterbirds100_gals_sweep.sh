...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/waterbirds100_gals_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/waterbirds100_gals_sweep_%j.err
...
OUT_CSV="$LOG_DIR/gals100_sweep_${SLURM_JOB_ID}.csv"
TRIAL_LOGS="$LOG_DIR/gals100_sweep_logs_${SLURM_JOB_ID}"

ARGS=(--config configs/waterbirds_100_gals.yaml
  --data-root "$DATA_ROOT"
