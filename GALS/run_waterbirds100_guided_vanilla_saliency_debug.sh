...
# Guided fixed params (copied from run_guided_waterbirds100_bestfixed_multigt_debug.sh)
GUIDED_SEED=${GUIDED_SEED:-0}
GUIDED_ATTENTION_EPOCH=${GUIDED_ATTENTION_EPOCH:-73}
GUIDED_KL_LAMBDA=${GUIDED_KL_LAMBDA:-495.60509512105125}
GUIDED_KL_INCR=${GUIDED_KL_INCR:-0.0}
GUIDED_BASE_LR=${GUIDED_BASE_LR:-5.721272343067835e-05}
GUIDED_CLASSIFIER_LR=${GUIDED_CLASSIFIER_LR:-0.003571025068268372}
GUIDED_LR2_MULT=${GUIDED_LR2_MULT:-0.122728778135035}
GUIDED_NUM_WORKERS=${GUIDED_NUM_WORKERS:-0}

# Vanilla fixed params (from user-provided Trial 9)
...
# GALS-ViT fixed params (from user-provided Trial 22)
RUN_GALS=${RUN_GALS:-1}
GALS_SEED=${GALS_SEED:-0}
GALS_CONFIG=${GALS_CONFIG:-configs/waterbirds_100_gals_vit.yaml}
GALS_DATA_ROOT=${GALS_DATA_ROOT:-/home/ryreu/guided_cnn/waterbirds}
GALS_WATERBIRDS_DIR=${GALS_WATERBIRDS_DIR:-waterbird_1.0_forest2water2}
GALS_ATTENTION_DIR=${GALS_ATTENTION_DIR:-clip_vit_attention}
GALS_BASE_LR=${GALS_BASE_LR:-0.01906797717764731}
GALS_CLASSIFIER_LR=${GALS_CLASSIFIER_LR:-0.0005160317852697908}
GALS_GRAD_WEIGHT=${GALS_GRAD_WEIGHT:-97631.97904483072}
