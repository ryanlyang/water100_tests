...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/guided95_openclip_laion_5seeds_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/guided95_openclip_laion_5seeds_%j.err
...
SUMMARY_CSV=${SUMMARY_CSV:-$LOG_DIR/guided95_openclip_laion_5seeds_${SLURM_JOB_ID}.csv}
...
for seed in $SEEDS; do
  run_log="$LOG_DIR/guided95_openclip_laion_seed${seed}_${SLURM_JOB_ID}.log"
  echo "=== seed=$seed ==="
...
echo "[DONE] Guided WB95 rerun complete."
