...
def main():
    p = argparse.ArgumentParser(description="Optuna/random sweep for vanilla Waterbirds.")
    ...
    p.add_argument("--model", choices=["resnet50", "resnet18", "clip_rn50", "mobilenet_v2", "mobilenet_v3_large"], default="clip_rn50")
    p.add_argument("--clip-model", default="RN50", help="Used when --model clip_rn50.")
    p.add_argument("--tune-mode", choices=["full", "layer4_head", "last_blocks_head", "linear_probe"], default="layer4_head")
    ...
    p.add_argument("--output-csv", default="vanilla_waterbird_clip_sweep.csv")

    p.add_argument("--post-seeds", type=int, default=5)
    p.add_argument("--post-seed-start", type=int, default=0)
    p.add_argument("--post-output-csv", default="vanilla_waterbird_clip_best5.csv")
