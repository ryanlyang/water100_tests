...
import run_elrep_waterbird as rew
...
def _run_trial(trial_id: int, args, rng: np.random.Generator, sampler_name: str) -> dict:
    ...
    best_balanced_val, test_acc, per_group, worst_group, ckpt = rew.run_single(run_args)
...
def main():
    p = argparse.ArgumentParser(description="Optuna/random sweep for ElRep Waterbirds ResNet-50.")
