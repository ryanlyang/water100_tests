#!/bin/bash -l
# GradCAM sweep for Waterbirds-95 using CLIP ViT attention maps.
...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/waterbirds95_gradcam_vit_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/waterbirds95_gradcam_vit_sweep_%j.err
...
OUT_CSV="/home/ryreu/guided_cnn/logsWaterbird/gradcam95_vit_sweep_${SLURM_JOB_ID}.csv"
TRIAL_LOGS="/home/ryreu/guided_cnn/logsWaterbird/gradcam95_vit_sweep_logs_${SLURM_JOB_ID}"

ARGS=(--method gradcam
  --config configs/waterbirds_95_gradcam_vit.yaml
  --data-root "$DATA_ROOT"
