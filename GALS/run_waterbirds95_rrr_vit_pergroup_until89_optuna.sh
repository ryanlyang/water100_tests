#!/bin/bash -l
# Waterbirds-95 RRR ViT sweep (Optuna), optimizing per_group test accuracy.
# Stops early once per_group >= 89 by default.
...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/wb95_rrr_vit_pergroup_until89_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/wb95_rrr_vit_pergroup_until89_%j.err
...
OUT_CSV="$LOG_DIR/wb95_rrr_vit_pergroup_until89_${SLURM_JOB_ID}.csv"
TRIAL_LOGS="$LOG_DIR/wb95_rrr_vit_pergroup_until89_logs_${SLURM_JOB_ID}"
