...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/waterbirds100_vanilla_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/waterbirds100_vanilla_%j.err
...
srun --unbuffered python -u main.py \
  --config configs/waterbirds_100_vanilla.yaml \
  DATA.ROOT="$DATA_ROOT" \
