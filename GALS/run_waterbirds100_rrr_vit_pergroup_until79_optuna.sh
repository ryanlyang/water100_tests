#!/bin/bash -l
# Waterbirds-100 RRR ViT sweep (Optuna), optimizing per_group test accuracy.
...
OUT_CSV="$LOG_DIR/wb100_rrr_vit_pergroup_until79_${SLURM_JOB_ID}.csv"
TRIAL_LOGS="$LOG_DIR/wb100_rrr_vit_pergroup_until79_logs_${SLURM_JOB_ID}"
