...
#SBATCH --mem=16G
#SBATCH --output=/home/ryreu/guided_cnn/logsRedMeat/redmeat_rrr_vit_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsRedMeat/redmeat_rrr_vit_sweep_%j.err
...
OUT_CSV="$LOG_DIR/redmeat_rrr_vit_sweep_${SLURM_JOB_ID}.csv"
TRIAL_LOGS="$LOG_DIR/redmeat_rrr_vit_sweep_logs_${SLURM_JOB_ID}"

ARGS=(--method rrr
  --config RedMeat_Runs/configs/redmeat_rrr_vit.yaml
  --data-root "$DATA_ROOT"
