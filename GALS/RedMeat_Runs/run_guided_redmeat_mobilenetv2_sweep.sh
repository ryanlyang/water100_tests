#!/bin/bash -l
# Guided KL / R4RR MobileNetV2 sweep for RedMeat.
...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsRedMeat/guided_redmeat_mobilenetv2_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsRedMeat/guided_redmeat_mobilenetv2_sweep_%j.err
