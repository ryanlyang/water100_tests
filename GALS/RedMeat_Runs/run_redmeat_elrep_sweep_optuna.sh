#!/bin/bash -l
# ElRep ERM sweep for RedMeat using our ResNet-50 student.
...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsRedMeat/redmeat_elrep_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsRedMeat/redmeat_elrep_sweep_%j.err
...
OUT_CSV=${OUT_CSV:-$LOG_DIR/redmeat_elrep_sweep_${SLURM_JOB_ID}.csv}
POST_OUT_CSV=${POST_OUT_CSV:-$LOG_DIR/redmeat_elrep_best5_${SLURM_JOB_ID}.csv}
CKPT_DIR=${CKPT_DIR:-$REPO_ROOT/ElRep_RedMeat_Checkpoints}
...
srun --unbuffered python -u RedMeat_Runs/run_elrep_redmeat_sweep.py "${ARGS[@]}"
