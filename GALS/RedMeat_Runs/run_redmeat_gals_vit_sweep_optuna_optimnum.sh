...
#SBATCH --mem=16G
#SBATCH --output=/home/ryreu/guided_cnn/logsRedMeat/redmeat_gals_vit_sweep_optimnum_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsRedMeat/redmeat_gals_vit_sweep_optimnum_%j.err
...
OUT_CSV="$LOG_DIR/redmeat_gals_vit_sweep_optimnum_${SLURM_JOB_ID}.csv"
TRIAL_LOGS="$LOG_DIR/redmeat_gals_vit_sweep_optimnum_logs_${SLURM_JOB_ID}"
