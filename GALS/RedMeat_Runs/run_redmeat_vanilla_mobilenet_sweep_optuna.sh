#!/bin/bash -l
# Vanilla MobileNetV3-Large sweep for RedMeat.
...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsRedMeat/redmeat_vanilla_mobilenet_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsRedMeat/redmeat_vanilla_mobilenet_sweep_%j.err
...
OUT_CSV=${OUT_CSV:-$LOG_DIR/redmeat_vanilla_mobilenet_sweep_${SLURM_JOB_ID}.csv}
POST_OUT_CSV=${POST_OUT_CSV:-$LOG_DIR/redmeat_vanilla_mobilenet_best5_${SLURM_JOB_ID}.csv}
CKPT_DIR=${CKPT_DIR:-$REPO_ROOT/Vanilla_MobileNet_RedMeat_Checkpoints}
