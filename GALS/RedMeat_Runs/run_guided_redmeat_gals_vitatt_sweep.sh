...
#SBATCH --mem=16G
#SBATCH --output=/home/ryreu/guided_cnn/logsRedMeat/guided_redmeat_galsvit_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsRedMeat/guided_redmeat_galsvit_sweep_%j.err
...
SWEEP_OUT=${SWEEP_OUT:-$LOG_DIR/guided_redmeat_galsvit_sweep_${SLURM_JOB_ID}.csv}
POST_OUT=${POST_OUT:-$LOG_DIR/guided_redmeat_galsvit_sweep_best5_${SLURM_JOB_ID}.csv}
