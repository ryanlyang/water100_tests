...
#SBATCH --mem=16G
#SBATCH --output=/home/ryreu/guided_cnn/logsRedMeat/redmeat_gals_rn50_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsRedMeat/redmeat_gals_rn50_sweep_%j.err
...
OUT_CSV="$LOG_DIR/redmeat_gals_rn50_sweep_${SLURM_JOB_ID}.csv"
TRIAL_LOGS="$LOG_DIR/redmeat_gals_rn50_sweep_logs_${SLURM_JOB_ID}"
