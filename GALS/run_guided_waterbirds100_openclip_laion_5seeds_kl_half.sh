#!/bin/bash -l
# WB100 local sensitivity: KL*0.75 (from 495.61 -> 371.7075), others fixed.
...
export KL_LAMBDA=371.7075
export SUMMARY_CSV="${SUMMARY_CSV:-/home/ryreu/guided_cnn/logsWaterbird/guided100_sens_kl075_${SLURM_JOB_ID}.csv}"
