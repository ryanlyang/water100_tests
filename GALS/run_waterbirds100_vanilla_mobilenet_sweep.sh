#!/bin/bash -l
# Vanilla MobileNetV3-Large sweep for Waterbirds-100.
...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/waterbirds100_vanilla_mobilenet_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/waterbirds100_vanilla_mobilenet_sweep_%j.err
...
OUT_CSV=${OUT_CSV:-$LOG_DIR/vanilla100_mobilenet_sweep_${SLURM_JOB_ID}.csv}
POST_OUT_CSV=${POST_OUT_CSV:-$LOG_DIR/vanilla100_mobilenet_best5_${SLURM_JOB_ID}.csv}
CKPT_DIR=${CKPT_DIR:-$REPO_ROOT/Vanilla_MobileNet_Checkpoints}
...
echo "Repo: $REPO_ROOT"
echo "Data: $DATA_PATH"
echo "Backbone: mobilenet_v3_large pretrained=1 tune_mode=full"
