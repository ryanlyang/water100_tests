#!/bin/bash -l
# Guided KL / R4RR MobileNetV3-Large sweep for Waterbirds-95.
...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/guided95_mobilenet_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/guided95_mobilenet_sweep_%j.err
...
SWEEP_OUT=${SWEEP_OUT:-$LOG_DIR/guided95_mobilenet_sweep_${SLURM_JOB_ID}.csv}
SEED_SWEEP_OUT=${SEED_SWEEP_OUT:-$LOG_DIR/guided95_mobilenet_best5_${SLURM_JOB_ID}.csv}
...
echo "[DONE] Waterbirds-95 guided MobileNet sweep + seed reruns complete."
