...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/guided_100_galsvit_resume_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/guided_100_galsvit_resume_%j.err
...
# Default targets failed WB100 guided_galsvit sweep job 21056089.
RESUME_CSV=${RESUME_CSV:-/home/ryreu/guided_cnn/logsWaterbird/guided_100_galsvit_sweep_21056089.csv}
# Set this to the original total trial count for that sweep (typically 50 from submit_all, or 100 standalone).
...
POST_OUT=${POST_OUT:-$LOG_DIR/guided_100_galsvit_sweep_best5_resume_${SLURM_JOB_ID}.csv}
...
# Stability first for transient image decode failures on shared storage.
