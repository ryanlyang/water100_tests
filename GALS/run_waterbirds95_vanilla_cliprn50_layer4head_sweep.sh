#!/bin/bash -l
# Vanilla CLIP RN50 layer4+head sweep (Optuna) for Waterbirds-95.
# Defaults:
# - 50 trials (TPE)
# - 200 epochs
...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/waterbirds95_vanilla_cliprn50_layer4head_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/waterbirds95_vanilla_cliprn50_layer4head_sweep_%j.err
...
OUT_CSV=${OUT_CSV:-$LOG_DIR/vanilla95_cliprn50_layer4head_sweep_${SLURM_JOB_ID}.csv}
POST_OUT_CSV=${POST_OUT_CSV:-$LOG_DIR/vanilla95_cliprn50_layer4head_best5_${SLURM_JOB_ID}.csv}
