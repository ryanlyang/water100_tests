...
OUT_CSV="$LOG_DIR/gals100_ourmasks_sweep_${SLURM_JOB_ID}.csv"
TRIAL_LOGS="$LOG_DIR/gals100_ourmasks_sweep_logs_${SLURM_JOB_ID}"

ARGS=(--config configs/waterbirds_100_gals_ourmasks.yaml
  --data-root "$DATA_ROOT"
