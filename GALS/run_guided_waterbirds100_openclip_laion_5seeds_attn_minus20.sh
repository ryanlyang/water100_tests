#!/bin/bash -l
# WB100 local sensitivity: attention_epoch-10 (from 73 -> 63), others fixed.
...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/guided100_sens_attnminus20_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/guided100_sens_attnminus20_%j.err
#SBATCH --signal=TERM@120

set -Eeuo pipefail

export ATTENTION_EPOCH=63
export SUMMARY_CSV="${SUMMARY_CSV:-/home/ryreu/guided_cnn/logsWaterbird/guided100_sens_attnminus10_${SLURM_JOB_ID}.csv}"
