#!/bin/bash -l
# RRR (gradient-based) sweep for Waterbirds-100 using CLIP ViT attention maps.
...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/waterbirds100_rrr_vit_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/waterbirds100_rrr_vit_sweep_%j.err
...
OUT_CSV="$LOG_DIR/rrr100_vit_sweep_${SLURM_JOB_ID}.csv"
TRIAL_LOGS="$LOG_DIR/rrr100_vit_sweep_logs_${SLURM_JOB_ID}"
