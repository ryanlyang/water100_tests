#!/bin/bash -l
# ElRep ERM sweep for Waterbirds-100 using our ResNet-50 student.
...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/waterbirds100_elrep_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/waterbirds100_elrep_sweep_%j.err
...
OUT_CSV=${OUT_CSV:-$LOG_DIR/elrep100_sweep_${SLURM_JOB_ID}.csv}
POST_OUT_CSV=${POST_OUT_CSV:-$LOG_DIR/elrep100_best5_${SLURM_JOB_ID}.csv}
