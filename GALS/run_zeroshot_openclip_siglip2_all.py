#!/usr/bin/env python3
"""Run zero-shot OpenCLIP LAION + SigLIP2 on DecoyMNIST, Waterbirds-95/100, and RedMeat test splits."""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Zero-shot OpenCLIP LAION + SigLIP2 on DecoyMNIST, Waterbirds95/100, and RedMeat test splits."
    )
    p.add_argument(
        "--wb95-path",
    ...
    p.add_argument("--variants", default="openclip_laion,siglip2")
    p.add_argument("--device", default="cuda")
    p.add_argument("--batch-size", type=int, default=256)
    p.add_argument("--num-workers", type=int, default=4)
    p.add_argument("--seeds", default="0")
    p.add_argument("--output-csv", default="zeroshot_openclip_siglip2_all_test.csv")
    return p.parse_args()
...
def main() -> None:
    ...
    variant_cfg = {
        "openclip_laion": (args.laion_model, args.laion_pretrained),
        "siglip2": (args.siglip2_model, args.siglip2_pretrained),
    }
    ...
    for seed in seeds:
        ...
        for variant in variants:
            ...
            model_name, pretrained = variant_cfg[variant]
            print(
