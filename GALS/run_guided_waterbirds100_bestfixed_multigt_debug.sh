...
# Avoid intermittent PIL decode failures from DataLoader workers on shared storage.
...
KL_INCR=0.0
BASE_LR=5.721272343067835e-05
CLASSIFIER_LR=0.003571025068268372
LR2_MULT=0.122728778135035
