#!/usr/bin/env python3
"""Fixed-hyperparameter multi-seed Waterbirds MobileNetV2 CE baseline."""
...
def main():
    p = argparse.ArgumentParser(description="Run Waterbirds MobileNetV2 CE baseline over fixed seeds.")
    p.add_argument("data_path")
    p.add_argument("teacher_map_path", nargs="?", default=None, help="Unused; kept for CLI parity.")
    ...
    p.add_argument("--output-csv", "--output_csv", dest="output_csv", default="waterbirds_mobilenetv2_ce_fixed5.csv")
    ...
    print(
        "[FIXED MULTI-SEED] Waterbirds MobileNetV2 CE | "
