#!/usr/bin/env python3
"""Generate Waterbirds-95/100 GALS RN50 Grad-CAM attentions (no Slurm required)."""
...
def main() -> None:
    ...
    parser.add_argument("--config-wb95", type=str, default="configs/waterbirds_95_attention.yaml")
    parser.add_argument("--config-wb100", type=str, default="configs/waterbirds_100_attention.yaml")
    parser.add_argument("--chunk-size", type=int, default=1000)
    parser.add_argument("--wb95-n", type=int, default=-1)
    parser.add_argument("--wb100-n", type=int, default=-1)
    ...
    cfg95 = _resolve_config(gals_root, args.config_wb95, "configs/waterbirds_95_attention.yaml")
    cfg100 = _resolve_config(gals_root, args.config_wb100, "configs/waterbirds_100_attention.yaml")
    ...
    print("[DONE] Waterbirds RN50 attention generation complete.")
