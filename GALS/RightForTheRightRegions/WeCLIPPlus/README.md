...
# IMPORTANT: install pydensecrf via conda-forge first
...
# Optional: from repo root, verify this environment
python ../pipelines/check_r4rr_weclip_env.py
```

If `pydensecrf` still fails through pip in your setup, install other deps without pulling transitive builds:
