#!/bin/bash -l
# Zero-shot eval on DecoyMNIST + Waterbirds95/100 + RedMeat using OpenCLIP LAION and SigLIP2.
...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsZeroShot/zeroshot_openclip_siglip2_all_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsZeroShot/zeroshot_openclip_siglip2_all_%j.err
...
VARIANTS=${VARIANTS:-openclip_laion,siglip2}

OUT_CSV=${OUT_CSV:-$LOG_DIR/zeroshot_openclip_siglip2_all_${SLURM_JOB_ID}.csv}
...
srun --unbuffered python -u run_zeroshot_openclip_siglip2_all.py \
  --wb95-path "$WB95_PATH" \
