#!/bin/bash -l
# One 50-trial Waterbirds-95 R4RR alignment-loss ablation.
# Submit through submit_waterbirds95_r4rr_alignment_sweeps.sh or set
...
TEACHER_MAP_ROOT=${TEACHER_MAP_ROOT:-/home/ryreu/guided_cnn/waterbirds/LearningToLook/code/WeCLIPPlus/results/val/prediction_cmap}
...
echo "[DONE] dataset=waterbirds95 alignment_loss=$ALIGNMENT_LOSS"
