#!/bin/bash -l
# Guided KL / R4RR MobileNetV2 sweep for Waterbirds-100.
...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/guided100_mobilenetv2_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/guided100_mobilenetv2_sweep_%j.err
