#!/bin/bash -l
# B2T-DRO sweep (Optuna) for Waterbirds-95.
...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/waterbirds95_b2t_dro_sweep_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/waterbirds95_b2t_dro_sweep_%j.err
...
OUT_CSV=${OUT_CSV:-$LOG_DIR/b2t_dro95_sweep_${SLURM_JOB_ID}.csv}
POST_OUT_CSV=${POST_OUT_CSV:-$LOG_DIR/b2t_dro95_best5_${SLURM_JOB_ID}.csv}
PSEUDO_BIAS_PATH=${PSEUDO_BIAS_PATH:-$LOG_DIR/b2t_dro95_pseudo_bias_${SLURM_JOB_ID}.pt}
