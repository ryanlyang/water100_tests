#!/bin/bash -l
# Re-run Waterbirds95 GALS+ViT with fixed Trial-11 hyperparameters for 5 seeds.
...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/waterbirds95_gals_vit_trial11_best5_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/waterbirds95_gals_vit_trial11_best5_%j.err
...
# Fixed Trial-11 hyperparameters (Waterbirds95 GALS+ViT sweep)
BASE_LR=${BASE_LR:-0.009095914443979123}
CLS_LR=${CLS_LR:-0.000988718410062346}
GRAD_WEIGHT=${GRAD_WEIGHT:-11213.40683824834}
...
OUT_CSV="$LOG_DIR/gals95_vit_trial11_best5_${SLURM_JOB_ID}.csv"
TRIAL_LOGS="$LOG_DIR/gals95_vit_trial11_best5_logs_${SLURM_JOB_ID}"
mkdir -p "$TRIAL_LOGS"
rm -f "$OUT_CSV"
...
for seed in "${SEEDS[@]}"; do
  ...
  RUN_PREFIX="gals95_vit_trial11_seed${seed}_${SLURM_JOB_ID}"
