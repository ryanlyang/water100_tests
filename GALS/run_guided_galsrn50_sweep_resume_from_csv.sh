...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterbird/guided_galsrn50_resume_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterbird/guided_galsrn50_resume_%j.err
...
ATT_ROOT=${ATT_ROOT:-/home/ryreu/guided_cnn/waterbirds/waterbird_complete95_forest2water2/clip_rn50_attention_gradcam}

# Default targets failed WB95 guided_galsrn50 sweep job 21056090.
RESUME_CSV=${RESUME_CSV:-/home/ryreu/guided_cnn/logsWaterbird/guided_galsrn50_sweep_21056090.csv}
# Set this to original target total trials for that run (typically 50 from submit_all, or 100 standalone).
...
POST_OUT=${POST_OUT:-$LOG_DIR/guided_galsrn50_sweep_best5_resume_${SLURM_JOB_ID}.csv}
...
# Most robust setting against transient decode issues on shared storage.
